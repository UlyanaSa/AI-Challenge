...
/**
 * Снимок задачи чата: состояние работы и каталог этапов. Тем же ответом сервер
 * отвечает и на чтение, и на взятие задачи в работу, и на паузу, и на забвение,
 * поэтому состояние полосы всегда берётся из ответа сервера, а не собирается
