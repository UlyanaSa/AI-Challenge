 ...
 * Стоимость передаётся уже отформатированными строками, чтобы клиент
 * не дублировал тарифы и правила округления.
 */
@Serializable
 ...
 * @param solutions Решения выбранных вариантов.
 */
@Serializable
...
/**
 * Ответ судьи.
 * @param verdict Текст вердикта: оценка каждого решения по параметрам
 *                и указание наиболее точного.
 */
@Serializable
